...
router.get('/favorites', getFavoriteMovies); // GET /api/movies/favorites - Listar favoritos
...
router.patch('/:id/rating', updateRating); // PATCH /api/movies/:id/rating - Actualizar rating 0-5
